...
## Role Overview
The Performance Engineer sub-role optimizes application performance, conducts performance testing, and implements performance monitoring solutions.
...
---
*This is a template README for the Performance Engineer sub-role. Please customize with specific details, responsibilities, and requirements relevant to your organization and project needs.*
