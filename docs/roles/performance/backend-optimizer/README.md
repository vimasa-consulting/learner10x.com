...
## Role Overview
The Backend Optimizer sub-role focuses on optimizing backend systems, database performance, and API response times.
...
---
*This is a template README for the Backend Optimizer sub-role. Please customize with specific details, responsibilities, and requirements relevant to your organization and project needs.*
