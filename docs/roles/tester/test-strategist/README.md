...
## Role Overview
The Test Strategist sub-role develops comprehensive testing strategies, defines quality standards, and ensures effective test coverage across all aspects of software development.
...
---
*This is a template README for the Test Strategist sub-role. Please customize with specific details, responsibilities, and requirements relevant to your organization and project needs.*
