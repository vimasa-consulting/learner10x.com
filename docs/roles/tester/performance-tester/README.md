...
## Role Overview
The Performance Tester sub-role focuses on testing application performance, load capacity, and optimization to ensure optimal user experience.
...
---
*This is a template README for the Performance Tester sub-role. Please customize with specific details, responsibilities, and requirements relevant to your organization and project needs.*
