...
## Role Overview
The Accessibility Tester sub-role ensures applications meet accessibility standards and provide inclusive experiences for users with disabilities.
...
---
*This is a template README for the Accessibility Tester sub-role. Please customize with specific details, responsibilities, and requirements relevant to your organization and project needs.*
