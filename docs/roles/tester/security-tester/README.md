...
## Role Overview
The Security Tester sub-role conducts security testing, vulnerability assessments, and penetration testing to identify and mitigate security risks.
...
---
*This is a template README for the Security Tester sub-role. Please customize with specific details, responsibilities, and requirements relevant to your organization and project needs.*
