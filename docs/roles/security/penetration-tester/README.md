...
## Role Overview
The Penetration Tester sub-role conducts security assessments, identifies vulnerabilities, and provides recommendations for security improvements.
...
---
*This is a template README for the Penetration Tester sub-role. Please customize with specific details, responsibilities, and requirements relevant to your organization and project needs.*
