...
## Role Overview
The Architect sub-role designs system architectures, technical roadmaps, and structural frameworks that support business goals and technical requirements.
...
---
*This is a template README for the Architect sub-role. Please customize with specific details, responsibilities, and requirements relevant to your organization and project needs.*
