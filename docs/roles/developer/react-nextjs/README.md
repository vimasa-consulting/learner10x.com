...
## Role Overview
The React/Next.js Developer sub-role focuses on building modern web applications using React and Next.js frameworks with optimal performance and user experience.
...
---
*This is a template README for the React/Next.js Developer sub-role. Please customize with specific details, responsibilities, and requirements relevant to your organization and project needs.*
